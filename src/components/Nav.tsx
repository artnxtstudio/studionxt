...
export default function Nav() {
  ...
  return (
    <>
      <nav className="hidden sm:flex bg-[#0D0B09] border-b border-[#2E2820] px-6 py-4 justify-between items-center sticky top-0 z-40">
      ...
      <div className="sm:hidden fixed bottom-0 left-0 right-0 z-50 bg-[#0D0B09] border-t border-[#2E2820]">
      ...
      {showAdd && (
        <div className="fixed inset-0 z-50" onClick={() => setShowAdd(false)}>
          <div className="absolute bottom-20 sm:bottom-auto sm:top-16 sm:right-6 left-4 right-4 sm:left-auto sm:w-64 bg-[#171410] border border-[#2E2820] rounded-2xl overflow-hidden shadow-2xl" onClick={e => e.stopPropagation()}>
            <div className="p-3 border-b border-[#2A2318]">
              <div className="text-xs text-purple-400 uppercase tracking-widest">Add to Studio</div>
            </div>
            <label className="flex items-center gap-4 px-4 py-4 hover:bg-[#1E1A16] cursor-pointer transition-all border-b border-[#2A2318]">
            ...
            <button onClick={() => { setShowAdd(false); router.push('/archive/wip/new'); }} className="flex items-center gap-4 px-4 py-4 hover:bg-[#1E1A16] transition-all w-full border-b border-[#2A2318]">
              <div className="w-10 h-10 bg-purple-900/50 rounded-xl flex items-center justify-center">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="text-purple-400">
            ...
            <button onClick={() => { setShowAdd(false); router.push('/archive/voices/new'); }} className="flex items-center gap-4 px-4 py-4 hover:bg-[#1E1A16] transition-all w-full">
              <div className="w-10 h-10 bg-purple-900/50 rounded-xl flex items-center justify-center">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="text-purple-400">
                  <path d="M12 1a3 3 0 00-3 3v8a3 3 0 006 0V4a3 3 0 00-3-3z"/>
