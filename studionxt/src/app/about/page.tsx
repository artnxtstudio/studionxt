    ...
    <div className="min-h-screen bg-[#0A0908] text-[#F5F0EB]">
      ...
      <div className="max-w-2xl mx-auto px-6 py-16 space-y-20">
        <div>
          ...
          <h1 className="text-4xl font-bold text-[#F5F0EB] leading-tight mb-6">Built for Artists,<br />By Artists</h1>
        ...
        <div>
          ...
          <div className="space-y-5 text-gray-400 text-base leading-relaxed">
            ...
            <p className="text-[#F5F0EB]">The art world has been completely left behind by the technology revolution. Accountants have better tools than artists. Real estate agents have better systems than galleries. It is absurd.</p>
        ...
        <div className="bg-[#141210] border border-[#2A2520] rounded-2xl p-8">
          ...
          <p className="text-[#F5F0EB] text-lg leading-relaxed font-medium">Every artist creates a body of work that tells a story. Our mission is to make that story visible, searchable, and preserved for future generations.</p>
        </div>
        <div>
          ...
          <div className="space-y-0">
            {[
              ...
              <div key={item.title} className="flex gap-4 py-5 border-b border-[#1A1715] last:border-0">
                <div className="w-1.5 h-1.5 rounded-full bg-purple-500 flex-shrink-0 mt-2" />
                <div>
                  <div className="text-sm font-semibold text-[#F5F0EB] mb-1">{item.title}</div>
        ...
        <div className="text-center pt-8 border-t border-[#1A1715]">
