      ...
      <div className="max-w-6xl mx-auto px-4 pt-5">
        ...
        {!loading && filtered.length === 0 && (
          <div className="text-center py-32">
            ...
            <div className="text-[#F5F0EB] font-medium mb-2">
            ...
            {filter === 'All' && (
              <button
                onClick={() => router.push('/archive/wip/new')}
                className="px-6 py-3 bg-purple-700 hover:bg-purple-600 text-[#F5F0EB] text-sm rounded-xl transition-all"
              >
              ...
              >
                ...
                <div className="p-3 sm:p-4">
                  <div className="flex justify-between items-start mb-1">
                    <div className="text-xs sm:text-sm font-medium text-[#F5F0EB] truncate flex-1 mr-2">
                      {work.title || 'Untitled'}
                    </div>
